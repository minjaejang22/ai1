...
# 모델 로드
# ======================
FILE_ID = st.secrets.get("GDRIVE_FILE_ID", "1cdbz-r9kShjyDwG8fujdaDUpwc_R0bq7")
...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
    ...
    labels[0] : {"texts" :["중국식 냉먄은 맛있어"], "images" : ["https://www.esquirekorea.co.kr/resources_old/online/org_online_image/eq/71c93efd-352d-4fb4-8a98-dd1b51475442.jpg"]},
    ...
    labels[3] : {"texts" :["탕수 맛있어"], "images" : ["https://i.namu.wiki/i/DQPzlCdDvbadZasufp6VhKSLDPHU4YlA1f9GbY2fP9nMvjNOSE32JZxL_ysj2duhcUtcWo-cGQvO_qS3rXctJw.webp"]},  
}   
# ======================
# 유틸
# ======================
